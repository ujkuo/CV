...
\begin{center}
  \textbf{\Huge \scshape Yu-Chieh (Jesse) Kuo} \\ \vspace{3pt}
   ...
   \hspace{.5pt} \href{tel:886917061223}{+886-917-061-223}
    ...
    $|$
   \hspace{.5pt} \textbf{\href{https://ujkuo.github.io}{https://ujkuo.github.io}} \\ \vspace{2pt}
   %\obj
   \end{center}
...
%            to build complete two-year panel data.}
        ...
        \resumeItem {Established and visualized large-scale network from
...
\section{Independent Research}
  ...
  the Presidential Election}\\
    ...
    \resumeItemListStart
      ...
      before and after the precidential election in the U.S. after surveying five pieces of 
      ...
      the performance of sentence embeddings from different 
          ...
          to determine the methodology to use and verified the scrapped data quality.}
      \resumeItem {Experimented the text's cosine similarity with TF-IDF
...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    ...
    \small{\item{
        ...
        Gurobi, NetworkX.} \\
      \textbf{Languages: }{Mandarin (Native), Taiwanese (Native), English (Proficiency).}
